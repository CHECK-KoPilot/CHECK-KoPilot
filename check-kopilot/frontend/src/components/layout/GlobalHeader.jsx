  ...
  return (
    ...
    >
      <div className="flex min-w-0 items-center gap-2">
        ...
        <KopilotIcon className="h-9 w-9 shrink-0 rounded-md lg:h-10 lg:w-10" />
        <span className="shrink-0 text-lg font-semibold text-slate-900 lg:text-xl">
          CHECK Kopilot
        </span>
        <span className="mx-1 hidden h-4 w-px bg-slate-200 sm:mx-2 sm:block" />
        <span className="truncate text-lg text-slate-500 lg:text-[19px]">
          {title}
        </span>
      </div>
